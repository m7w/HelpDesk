...
public class CommentControllerTest extends AbstractControllerTest {
    ...
    private static final CommentDto DTO1= new CommentDto(USER1_ID, "Lenny", "Lenny message",
            LocalDateTime.parse("2022-04-03T10:15:30"), TICKET_ID);
    private static final CommentDto DTO2= new CommentDto(USER2_ID, "Homer", "Homer message",
            LocalDateTime.parse("2022-04-03T11:15:30"), TICKET_ID);
    ...
    public void testGetByTicketId() throws Exception {
        ...
        when(commentService.findByTicketId(TICKET_ID))
    ...
    public void testSave() throws Exception {
        ...
        mockMvc.perform(post("/api/tickets/{ticnetId}/comments", TICKET_ID)
